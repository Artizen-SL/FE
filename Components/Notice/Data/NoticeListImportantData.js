...
const NoticeListImportantData = () => {
  const importantDatas = [
    ...
    {
      noticeId: 3,
      noticeTitle: "세 번째 공지입니다.",
      noticeContent: "세 번째 공지 내용입니다.",
      noticeDate: "2022/01/02",
      notieImage:
        "https://images.pexels.com/photos/139764/pexels-photo-139764.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    },
    {
      noticeId: 4,
      noticeTitle: "네 번째 공지입니다.",
      noticeContent: "네 번째 공지 내용입니다.",
      noticeDate: "2022/01/02",
      notieImage:
        "https://images.pexels.com/photos/139764/pexels-photo-139764.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    }, ];

  return importantDatas;
};

export default NoticeListImportantData;
