...
| 페이지                    | API 연결, 기능 및 CSS                                                                               |
| ------------------------- | --------------------------------------------------------------------------------------------------- |
| 로그인, 회원가입 - 서지운,국경훈  | ✅카카오 로그인<br>✅로그인<br>✅로그아웃                                                            |
| 메인페이지 - 임소희         | ✅로그아웃<br>✅마이페이지 차트<br>                                                                 |
| 카테고리 - 서지운         | ✅로그아웃<br>✅마이페이지 차트<br>                                                                 |
| 커뮤니티 - 서지운         | ✅배너<br>✅카테고리<br>✅인기모임 <br>✅상단TOP 버튼 <br>✅채팅 버튼 <br>✅ 후기 3개 최신 불러오기 |
| 상세페이지 - 서지운       | ✅카테고리 별 sort<br>                                                                              |
| 검색페이지- 임소희             | ✅등록된 모임 정보 불러오기<br>                                                                     |
| 공지페이지 - 임소희        | ✅관심 모임 등록<br>                                                                                |
| 마이페이지(메인) - 국경훈, 임소희   | ✅모임 가입하기 탈퇴하기<br>                                                                        |
| 마이페이지(글목록, 티켓목록, 좋아요 리스트 ) - 임소희 | ✅모임 작성하기, 네이버 책 검색, Pagination<br>                                                     |
| 마이페이지(티켓기록하기) - 서지운  | ✅모임 수정하기, 네이버 책 검색, Pagination<br>                                                     |
